...
KEYWORDS = [
    "압구정쌍수","눈성형","눈수술","눈추천","자연유착","자연유착쌍수","매몰법","절개법","쌍꺼풀","쌍꺼풀수술","눈재수술",
    "쌍꺼풀재수술","인라인","인아웃라인","세미아웃","세미아웃라인","아웃라인","트임","앞트임","위트임","뒤트임","밑트임",
    "상안검","하안검","눈매교정","눈밑지방재배치","눈썹하거상","리프팅추천","거상수술","안면거상","이마거상","미니거상","실리프팅",
    "리프팅","이중턱","남자눈성형","코수술","코성형","코추천","쌍수","자연유착쌍꺼풀","쌍꺼풀매몰법","쌍꺼풀절개법","쌍수붓기",
    "쌍수후기","쌍꺼풀라인","재수술붓기","쌍수 회복기간","세미아웃라인 쌍꺼풀","인아웃라인 세미아웃 차이"
]
